//b)	You are given an array of different words and target words. Each character of a word represents a different digit ranging
// from 0 to 9, and no two character are linked to same digit. If the sum of the numbers represented by each word on the array equals
// the sum the number represented by the targeted word, return true; otherwise, return false. Note: Provided list of words and targeted
...
public class Question_6b {
    ...
    // returns value of the array that is words
    ...
    public static void main(String[] args){
        ...
        Question_6b answer = new Question_6b();
