...
public class Question_7b {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
//            Although here is this link but after opening this link it do not open the page instead it says content is not available
            results.add(executorService.submit(new CrawlTask("https://www.facebook.com/hikmat.saud.3" + i)));
        }
